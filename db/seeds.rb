...
b11 = Book.create(title: "The Nightingale", author: "Kristin Hannah", description: "The Nightingale tells the stories of two sisters, separated by years and experience, by ideals, passion and circumstance.", publisher: "St. Martin's Press", weeks_on_list: 10, rank_this_week: 12)
Review.create(comment: "I loved Kristin Hannah's The Nightingale. She has captured a particular slice of French life during World War II with wonderful details and drama.", author: "Lisa See, #1 New York Times bestseller author of Snow Flower and the Secret Fan", book_id: b11.id)
Review.create(comment: "I found The Nightingale absolutely riveting! I started reading it one night after supper with every intention of reading just a few chapters for that evening and could not put it down.", author: "Dr. Miriam Klein Kassenoff, Director of the University of Miami Holocaust Teacher Institute", book_id: b11.id)

b12 = Book.create(title: "Green on Blue: A Novel ", author: "Elliot Ackerman", description: "From a decorated veteran of the Iraq and Afghan Wars, and White House Fellow, a stirring debut novel about a young Afghan orphan and the harrowing, intractable nature of war.", publisher: "Scribner", weeks_on_list: 15, rank_this_week: 11)
Review.create(comment: "Green on Blue is harrowing, brutal, and utterly absorbing.", author: "Khaled Hosseini, author of The Kite Runner", book_id: b12.id)
Review.create(comment: "Green on Blue is a remarkable achievement, a novel of war, betrayal, love, and honor that feels equally timeless and timely.", author: "Anthony Marra, author of A Constellation of Vital Phenomenara", book_id: b12.id)